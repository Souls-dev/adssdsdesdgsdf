...
import { Award, Heart, Home, Handshake, ShieldCheck, Sparkles } from "lucide-react";

const STATS = [
  { value: "32+", label: "Years of Legacy", icon: Award },
  { value: "500+", label: "Happy Families", icon: Heart },
  { value: "14", label: "Premium Farmhouses", icon: Home },
];
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <h3
              className="mb-4 text-2xl font-bold text-[#451a03] sm:text-3xl"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              32 Years of{" "}
              <span className="text-[#b45309]">Unmatched Hospitality</span>
            </h3>
            <p className="mb-4 text-base leading-relaxed text-[#78350f]/75">
            ...
            <p className="mb-6 text-base leading-relaxed text-[#78350f]/75">
            ...
            {/* Our Promise card */}
            <div className="rounded-2xl border border-[#b45309]/10 bg-gradient-to-br from-[#fef3c7]/50 to-white p-6">
              <h4
                className="mb-2 text-lg font-bold text-[#451a03]"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                Our Promise
              </h4>
              <p className="text-sm leading-relaxed text-[#78350f]/70">
        ...
        <div className="mb-20">
          <h3
            className="mb-10 text-center text-3xl font-bold text-[#451a03] sm:text-4xl"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            Our Core Values
          </h3>
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            {VALUES.map((value) => {
              ...
              return (
                ...
                >
                  <div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-gradient-to-br from-[#fef3c7] to-[#fde68a] opacity-40 blur-2xl transition-transform duration-700 group-hover:scale-150" />
                  
                  <div className="relative z-10">
                    <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#b45309] to-[#92400e] shadow-lg transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
                      <Icon size={26} className="text-[#fef3c7]" />
                    </div>
                    <h4
                    ...
                    <p className="text-base leading-relaxed text-[#78350f]/75">
                      {value.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6">
          {STATS.map((stat) => {
            ...
            return (
              ...
              >
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#b45309] to-[#92400e] shadow-lg transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
                  <Icon size={28} className="text-[#fef3c7]" />
                </div>
                <div>
                  <p
                    className="text-3xl font-bold text-[#451a03] lg:text-4xl"
                    style={{ fontFamily: "var(--font-heading)" }}
                  >
                    {stat.value}
                  </p>
                  <p className="text-sm font-medium text-[#78350f]/70 uppercase tracking-wider mt-1">
                    {stat.label}
                  </p>
                </div>
              </div>
